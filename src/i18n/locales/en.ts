...
const en: Dictionary = {
  ...
  header: {
    ...
    harmony: {
      ...
      qualityMaj: 'Major',
      qualityMin: 'Minor',
      qualityDim: 'Diminished',
      qualityAug: 'Augmented',
      qualityPow: 'Power chord',
      qualityEditTip: 'Editing the quality of the selected chord.',
      qualityDisabledTip: 'Select a chord to change its quality.',
    },
