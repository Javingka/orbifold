...
const es: Dictionary = {
  ...
  header: {
    ...
    harmony: {
      ...
      soundLabel: 'timbre',
      instrLabel: 'onda',
      instrSawtooth: 'sierra',
      instrSine: 'seno',
      instrSquare: 'cuadrada',
      instrTriangle: 'triángulo',
      roomLabel: 'reverb',
      roomTip: 'Nivel de reverberación (0 = seco, 1 = máximo).',
      decayLabel: 'decay',
      decayTip: 'Tiempo de caída de la amplitud en segundos (0 = sin decay).',
    },
