...
const es: Dictionary = {
  ...
  header: {
    ...
    harmony: {
      ...
      qualityMaj: 'Mayor',
      qualityMin: 'Menor',
      qualityDim: 'Disminuido',
      qualityAug: 'Aumentado',
      qualityPow: 'Power chord',
      qualityEditTip: 'Editando la calidad del acorde seleccionado.',
      qualityDisabledTip: 'Selecciona un acorde para cambiar su calidad.',
    },
